...
class Fan extends StatefulWidget {
  ...
  @override
  State<Fan> createState() => _FanControlPageState();
}

class _FanControlPageState extends State<Fan> {
  ...
  void _loadState() async {
    ...
    for (final deviceStr in savedDevices) {
      ...
      if (json['deviceId'] == widget.device.deviceId) {
        setState(() {
          _brightness = (json['brightness'] ?? _brightness).clamp(0, 10);
  ...
  void _updateBrightness(double value) {
    setState(() => _brightness = value.round().clamp(1, 10));
    _saveState();
                ...
                GestureDetector(
                  ...
                  child: Transform.translate(
                    ...
                    child: SvgPicture.asset(
                      'assets/icons/Devices_Icons/Fan.svg',
                      height: 77,
                      width: 77,
                    ),
                  ),
                                              ...
                                              child: SizedBox(
                                                ...
                                                child: SliderTheme(
                                                  data: SliderTheme.of(context).copyWith(
                                                    trackHeight: 100 * (sliderHeight / 400),                                                    inactiveTrackColor: Colors.transparent,
